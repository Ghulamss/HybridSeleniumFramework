...
public class Transaction360Report {
	static WebDriver driver;

	private final static Logger log = LoggerHelper.getLogger(Transaction360Report.class);
...
/*  Transaction Approvaal Checker x path */
	...
	/*************Report 360 Maker *****************************/
	//*[text()='MIS']//parent::a
	@FindBy(xpath = "//*[text()='MIS']//parent::a")
	WebElement MISReport;
	@FindBy(xpath = "//*[text()='Transaction 360 Report']//parent::a")
	WebElement Transaction360Report;
	@FindBy(xpath = "//*[text()='Transaction Report']")
	WebElement verifyTransactionReport;
	@FindBy(xpath = "//input[@name='trn']")
	WebElement cotporateRefrenceNumber;
	@FindBy(xpath = "//input[@name='Submit']")
	WebElement SubmitButtonOnTransactionReport;
	
	
	private String TransactionFileStatus;

	public Transaction360Report(WebDriver driver) {
		this.driver = driver;
...
//		static String getcorporateid;
	...
	// verify Succesfull Message on Checker  Page.
		...
		static String  getcotporateRefrenceNumber;
  
		public void clickOnMISReportMenu() {
	  log.info("Click On MIS Report ==>");
	  MISReport.click();
  }
  public void clickOnTransaction360Report() {
	  log.info("click On Transaction 360 Report ==>");
	  Transaction360Report.click();
  }
  public void verifyTransactionReportPage()
  {
	 //driver.switchTo().defaultContent();
	  Assert.assertEquals("TRANSACTION REPORT",  verifyTransactionReport.getText(),"TRANSACTION REPORT Page Has not Verify");
  }	
  public void toswitchField() throws Exception {
		Thread.sleep(5000);
		List<WebElement> iframeElements = driver.findElements(By.tagName("iframe"));
		System.out.println(iframeElements);
     driver.switchTo().frame(0);
...
//		log.info(" To switch the main Enter values " + Fieldsareinmandatory.getText());
  ...
  public void entercotporateRefrenceNumber(String  cotporateRefrenceNumber) {
	  log.info("enter cotporate Refrence Number ==>"+cotporateRefrenceNumber);
this.cotporateRefrenceNumber.sendKeys(cotporateRefrenceNumber);
getcotporateRefrenceNumber=cotporateRefrenceNumber.toString();
System.out.println("getcotporateRefrenceNumber ==>"+getcotporateRefrenceNumber);
  }
  public void clickOnSubmitButtonOnTransactionReport() {
	  log.info("click On Submit Button On Transaction Report==>");
	  SubmitButtonOnTransactionReport.click();
  }
