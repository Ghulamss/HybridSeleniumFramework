...
:README
	...
	ECHO ******************************************************************************
	ECHO.
	ECHO		ManageEngine Remote Access Plus Setup Wizard
	ECHO.
	ECHO This script will install the Remote Access Plus agent in the computer.
	ECHO.
	ECHO ******************************************************************************
	ECHO.
	ECHO.
	:GETINPUT
	ECHO  1 - Install Remote Access Plus Agent in this computer
	ECHO.
	ECHO  2 - Exit
	ECHO.
	set INPUT=
...
:INSTALLAGENT
	...
	start /wait msiexec /i RemoteAccessPlusAgent.msi TRANSFORMS="RemoteAccessPlusAgent.mst" ENABLESILENT=yes REBOOT=ReallySuppress INSTALLSOURCE=Manual /lv Agentinstalllog.txt
...
:AGENTINSTALLSUCCESS
ECHO.
ECHO Remote Access Plus Agent installed successfully.
ECHO.
GOTO ENDFILE
...
ECHO.
ECHO -----------------------------------------------------------------------------
ECHO Remote Access Plus Agent installation failed. ErrorCode: %ERRORLEVEL%."
...
ECHO.
ECHO Remote Access Plus Agent installation failed. ErrorCode: %ERROR%
net helpmsg %ERROR%
ECHO -----------------------------------------------------------------------------
GOTO ENDFILE
